...
export default function AdminDashboard() {
  ...
  const stats = {
    ...
    activeUsers: 892,
    newUsers: 45,
    totalRevenue: 'R$ 125.400,00'
  };

  const recentUsers = [
    { id: 1, name: 'João Silva', email: 'joao@email.com', status: 'Ativo', date: '28/01/2026' },
    { id: 2, name: 'Maria Santos', email: 'maria@email.com', status: 'Ativo', date: '28/01/2026' },
    { id: 3, name: 'Pedro Costa', email: 'pedro@email.com', status: 'Inativo', date: '27/01/2026' },
    { id: 4, name: 'Ana Paula', email: 'ana@email.com', status: 'Ativo', date: '27/01/2026' },
  ];
      ...
      <main className="admin-main">
        ...
        <div className="admin-stats-grid">
          ...
          <div className="admin-stat-card">
            ...
            <div className="stat-info">
              <p className="stat-label">Novos Hoje</p>
              <h3 className="stat-value">{stats.newUsers}</h3>
              <span className="stat-change positive">+18% vs ontem</span>
            </div>
          </div>
                  ...
                  <tr key={user.id}>
                    ...
                    <td>
                      <div className="action-buttons">
                        ...
                        <button className="btn-icon" title="Deletar">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
